...
fs.readFile('client_secret.json', function processClientSecrets(err, content) {
  ...
  // Drive API.
  authorize(JSON.parse(content), insertPicture);
});
...
/**
* INSERT PICTURE FUNCTION -- called to place an img into a person's gDrive Pictures folder
*
...
/* (Currently Unused) Local Helper Function -- list out items in Google Drive */
// test that reads from google drive
